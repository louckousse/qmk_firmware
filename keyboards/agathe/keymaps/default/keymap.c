...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [QWERTY] = LAYOUT(
        ...
        KC_LCTL,          KC_LGUI, LWR_SPC, KC_LALT,                   LWR_SPC, KC_RCTL,                            KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [LOWER] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_INS,
        _______, KC_MPLY, KC_VOLU, KC_MUTE, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RESET,
